<template>
	<tr @click="goTo">
		...
		<td>
			<AccountAddress :address="row.payer"></AccountAddress>
		</td>
		<td>
			<SignatureAddress :address="row.signature"></SignatureAddress>
		</td>
...
export default {
	name: "LatestRow",
	components: {SignatureAddress, AccountAddress},
	data() {
		return {
			image: ""
		}
	...
	methods: {
		goTo: function() {
			this.$router.push(`/bonks/${this.row.id}`)
		},
